...
class test_inventory(unittest.TestCase):
	...
	def test_add_invoice(self):
		...
		comp.append(comp_item)
		invo_db.add_invoice(990,200,15,300, "Hericho", datetime.datetime.now() + datetime.timedelta(days=30), "Fanalili", comp)
		invo_db.close_connection()

	def test_update_value(self):
		invo_db = InvoiceDB()
		last_invoice = invo_db.get_lastid()
		invo_db.update_value(last_invoice, 660, 120, 20, 250)
		invo_db.close_connection()
