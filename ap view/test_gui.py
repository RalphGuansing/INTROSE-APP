...
from ViewAPV import AccountsPayable_MonthlyView, input_month_year
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def ap_cust_monthly_dia(self):
        ...
        self.dialog_monthly.layout.bSubmit.clicked.connect(self.add_apv_tab)
